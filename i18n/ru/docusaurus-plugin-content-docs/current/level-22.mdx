...
В официальном источнике отдельного набора контрольных вопросов для 22-го уровня нет; ниже — наши тренировочные вопросы по материалу этого уровня.
...
<summary>
  6. Один экстренный сброс заставляет Боба Chop Move, но Кэти должна
  использовать появившийся жетон и не Chop Move. Нужно ли выбирать между Scream
  Discard и Generation Discard?
</summary>

<div className="ru-training-answer" data-ru-search-exclude="true">

Нет. Один и тот же сброс может быть Scream Discard для Боба и Generation Discard для Кэти. Такая композиция двух сообщений — Composition Discard.

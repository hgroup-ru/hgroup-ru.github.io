...
В официальном источнике отдельного набора контрольных вопросов для 19-го уровня нет; ниже — наши тренировочные вопросы по материалу этого уровня.
...
<summary>
  4. После 5 Pull до следующего хода Pulled-игрока никто не сделал blind-play.
  Может ли это всё ещё быть обычный 5 Pull Finesse с Reverse Finesse после его
  хода?
</summary>

<div className="ru-training-answer" data-ru-search-exclude="true">

Нет. Обычный 5 Pull Finesse должен быть продемонстрирован blind-play до следующего хода Pulled-игрока, то есть быть Forward Finesse. Компонент Reverse Finesse возможен только как второй blind-play в 5 Pull Double Finesse.

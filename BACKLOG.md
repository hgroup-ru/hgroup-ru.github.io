...
Особый случай — [`misc/rules.md`](misc/rules.md): не включать его в translation batch и не делать прямой перевод текста официального буклета. Базовые правила для RU-сайта вынесены в отдельную задачу ниже как самостоятельный авторский onboarding-материал.

...
Ближайший scope — **Level 13**. Для каждого следующего уровня сначала перечитать pinned official material и все предыдущие применимые conventions, затем подготовить ограниченный набор однозначных позиций и провести semantic QA до публикации.
...
Не продолжать автоматически на Levels 16–19 без подходящего pinned source. Levels 23–24 не дублировать локальными вопросами без отдельного решения, поскольку upstream уже содержит official questions.

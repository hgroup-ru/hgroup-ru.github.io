...
Оценить более полезный Home для пользователя с сохранённым «Мой уровень»: например, более явное «Продолжить обучение» и быстрый переход к следующему логичному материалу.

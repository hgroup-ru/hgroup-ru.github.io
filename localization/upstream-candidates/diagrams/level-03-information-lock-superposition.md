# Level 3 — Information Lock: superposition
...
**Что показывает:** Показывает Information Lock в суперпозиции `r2 / b2`: дальнейшая информация может её сузить, но не добавить новый вариант.
**Зачем:** сложный пример уже имеет визуальное представление и не требует отдельного renderer.

## Текущая реализация

- [`i18n/ru/docusaurus-plugin-content-docs/current/level-3/local-information-lock-superposition.yml`](../../../i18n/ru/docusaurus-plugin-content-docs/current/level-3/local-information-lock-superposition.yml)

# Level 3 — Information Lock: break
...
**Что показывает:** Показывает прямое противоречие: ранее зафиксированная `r2` получает синюю подсказку и Information Lock ломается до `b2`.
**Зачем:** сложный пример уже имеет визуальное представление и не требует отдельного renderer.

## Текущая реализация

- [`i18n/ru/docusaurus-plugin-content-docs/current/level-3/local-information-lock-break.yml`](../../../i18n/ru/docusaurus-plugin-content-docs/current/level-3/local-information-lock-break.yml)

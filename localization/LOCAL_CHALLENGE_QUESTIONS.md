# Авторинг и ревью локальных Training Questions

Этот документ — единый редакционный и semantic-стандарт для вопросов, подготовленных H-Group RU. Они являются локальным учебным материалом и **не являются Official Challenge Questions H-Group**.

Правила ниже не применяются ретроактивно к официальным Challenge Questions: официальный материал сохраняется source-faithfully. Для локальных вопросов цель — не количество и не механическое покрытие каждого абзаца Level, а небольшой набор сильных задач, которые проверяют Hanabi reasoning и помогают учиться на ошибках.

## 1. Публикационный критерий

Хороший Training Question должен заслуживать место рядом с основной документацией. Он должен заставлять применить материал, распознать interpretation, boundary, interaction, misconception или временную причинность, а не пересказать абзац Level или вспомнить название convention.
